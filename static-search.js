class StaticSearch extends HTMLElement {
  ...
  formHandler = async (event) => {
    ...
    try {
      ...
      let response = await fetch(
        'http://localhost:3000/api/v1/search-query/ksq5yrf0n4laszgv9rekt2yd6eqqrg',
        {
          method: 'POST',
          headers: {
  ...
  renderSearchResults = (newValue) => {
    ...
    const searchProvidedBy = `<li id="search-provided-by-message"><a href="https://staticsearch.com" id="search-provided-by-message-link">staticsearch.com</a></li>`;
